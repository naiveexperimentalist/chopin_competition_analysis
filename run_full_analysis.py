...
def main():
    ...
    parser.add_argument('--stage1', required=True, help='CSV file with stage 1 scores by judge')
    parser.add_argument('--stage2', required=True, help='CSV file with stage 2 scores by judge')
    parser.add_argument('--stage3', required=True, help='CSV file with stage 3 scores by judge')
    parser.add_argument('--final', required=True, help='CSV file with final scores by judge')
